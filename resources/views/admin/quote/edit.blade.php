                                ...
                                @if(isset($objQuote->complaint))
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="hidden" class="form-control" name="complaint"
                                               id="complaintVal" value="{{$objCompOrAsset->id}}"
                                               placeholder="Complaint"/>
                                    </div>
                                @endif
                            ...
                            <div class="box-body">
                                <table class="table table-bordered" id="item_table">
                                    ...
                                    @foreach(json_decode($objQuote->quote) as $index => $invoice)
                                        <tr>
                                            <td><input name="quote[{{$index}}][product]" data-type="boq"
                                                       class="form-control item_product search"
                                                       value="{{$invoice->product}}" data-count="{{$index}}"
                                                       id="product{{$index}}"/>
                                                <div id="productList{{$index}}"></div>
                                            </td>
                                            <td><input type="number" name="quote[{{$index}}][unit]"
                                                       data-count="{{$index}}" value="{{$invoice->unit}}"
                                                       class="form-control item_unit calculate price"
                                                       id="unit{{$index}}"/></td>
                                            <td><input type="number" name="quote[{{$index}}][quantity]"
                                                       data-count="{{$index}}" id="quantity{{$index}}"
                                                       value="{{$invoice->quantity}}"
                                                       class="form-control qty item_quantity calculate"/></td>
                                            <td>
                                                <input type="number" name="quote[{{$index}}][total]"
